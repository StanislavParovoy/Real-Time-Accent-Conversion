...
parser.add_argument("--train-dir", '-td', required=True)
parser.add_argument("--dev-dir", '-dd', required=True)
...
from AcousticModel.Conformer.dataset import DatasetNG
